...
public class CommomDialog extends Dialog implements View.OnClickListener{
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.submit:
                if(listener != null){
                    listener.onClick(this,edit_start.getText().toString(),edit_end.getText().toString(), true);
                }
                break;
        }
    }
    ...
    public interface OnCloseListener{
        void onClick(Dialog dialog,String start,String end, boolean confirm);
    }
}
